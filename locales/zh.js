const zh = {
  ...
  __COMMAND_BOT_ACTIVATE_ALIASES: ['說話', '開始說話','呼叫群益飛虎Mr. Chen'],
  __COMMAND_BOT_ACTIVATE_REPLY: '已呼叫群益飛虎Mr. Chen，試下問問: 「甚麼是當沖？」',
  ...
  __COMMAND_BOT_DEACTIVATE_ALIASES: ['閉嘴', '停止說話','關閉群益飛虎Mr. Chen'],
  __COMMAND_BOT_DEACTIVATE_REPLY: '已關閉群益飛虎Mr. Chen，我們將由真人客服為您服務',
  ...
  __ERROR_ECONNABORTED: '群益飛虎Mr. Chen覺得這個問題太複雜了',
  __ERROR_UNKNOWN: '群益飛虎Mr. Chen恍神了，請點選聯絡我們，我們將由專人為您服務!',
  __ERROR_MAX_GROUPS_REACHED: '群組數量到達上限了',
  __ERROR_MAX_USERS_REACHED: '用戶數量到達上限了',
  __ERROR_MISSING_ENV: (v) => `缺少環境變數：${v}`,
  __MESSAGE_NEW_VERSION_AVAILABLE: (version) => `請更新至最新版版`,
